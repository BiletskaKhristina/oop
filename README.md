# 🐍 Лабораторна робота: Віртуальні середовища та сторонні бібліотеки

Цей проєкт присвячений вивченню інструментів ізоляції залежностей у Python, роботі з менеджерами пакетів та створенню простого веб-інтерфейсу для взаємодії з API.

## 🎯 Мета проєкту
- Опанувати роботу з `venv`, `Pipenv` та `Poetry`.
- Навчитися інтегрувати сторонні бібліотеки: `Flask`, `requests`, `jikanpy`.
- Вивчити механізм роботи зі змінними оточення (`.env`).
...
Створення базового віртуального середовища для ізоляції проєкту:
```bash
...
## 5. Використання Poetry
 ...
 • Які нові знання отримано: робота з venv, Pipenv, Poetry, Flask, requests, jikanpy, змінними середовища.
 • Чи вдалося відповісти на всі питання: так, усі завдання виконані.
 • Чи вдалося виконати всі завдання: так.
 • Чи виникли складності: спочатку була невпевненість у Flask та підключенні бібліотек, але все вдалося після перевірки кроків.
 • Чи подобається формат здачі: так, зручний та покроковий.
 • Побажання для покращення: додати приклади складніших API-запитів та інтерактивного веб-виводу для практики.