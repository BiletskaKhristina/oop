...
Тема: Віртуальні середовища та робота зі сторонніми бібліотеками в Python

Мета роботи: Навчитися створювати та використовувати віртуальні середовища Python, встановлювати сторонні бібліотеки (requests, jikanpy, Flask), запускати програми через Pipenv та Poetry, працювати зі змінними середовища та створювати простий веб-сайт на Flask.

⸻

Виконання роботи

Завдання 1. Створення віртуального середовища (venv)
 • Що зроблено: створено папку проєкту lab_python та середовище my_env.
 • Команди терміналу:
